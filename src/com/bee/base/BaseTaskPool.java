...
import com.bee.common.AppClient;
...
public class BaseTaskPool {
	...
	public void addTask (int taskId, JSONObject mJSONObject,BaseTask baseTask, int delayTime) {
		baseTask.setId(taskId);
		try {
			taskPool.execute(new TaskThread(context, "", null, baseTask, delayTime));
		} catch (Exception e) {
			taskPool.shutdown();
		}
	}
