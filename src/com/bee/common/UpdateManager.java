...
public class UpdateManager {
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg){
		...
		if(isShowMsg){
			...
			mProDialog = ProgressDialog.show(mContext, null, "正在检测，请稍候...", true, true);
			/*if(mProDialog == null)
			{	mProDialog = ProgressDialog.show(mContext, null, "正在检测，请稍候...", true, true);}*/
			/*else{
	...
	private Runnable mdownApkRunnable = new Runnable() {	
		...
		public void run() {
			try {
				String apkName = "ChinaBee_"+mUpdate.getVersionName()+".apk";
				String tmpApk = "ChinaBee_"+mUpdate.getVersionName()+".tmp";
				//判断是否挂载了SD卡
				String storageState = Environment.getExternalStorageState();		
				if(storageState.equals(Environment.MEDIA_MOUNTED)){
					savePath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/chinabee/Update/";
