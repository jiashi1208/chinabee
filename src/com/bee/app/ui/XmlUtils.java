...
public class XmlUtils
{
     ...
     *
     * @see #writeMapXml(java.util.Map, String, org.xmlpull.v1.XmlSerializer)
     * @see #writeListXml
     * @see #writeValueXml
     * @see #readMapXml
     */
     ...
     * @param out Where to write the XML data.
     *
     * @see #writeListXml(java.util.List, String, org.xmlpull.v1.XmlSerializer)
     * @see #writeMapXml
     * @see #writeValueXml
     * @see #readListXml
     */
     ...
     *
     * @see #writeMapXml(java.util.Map, java.io.OutputStream)
     * @see #writeListXml
     * @see #writeValueXml
     * @see #readMapXml
     */
     ...
     *
     * @see #writeListXml(java.util.List, java.io.OutputStream)
     * @see #writeMapXml
     * @see #writeValueXml
     * @see #readListXml
     */
